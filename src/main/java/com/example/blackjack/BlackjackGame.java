...
/*
Orchestrates manages the interactions and gameplay in the blackjack game. 
It uses encapsulation to control how the game progresses and how players interact
Provides methods of betting, playing, and other aspects of the game.
Controls the order in which players interact and act in the game.
 */
...
public class BlackjackGame {
	...
	public void initializeGame(){
		...
		try {
			...
			System.out.println("An error occurred during game initialization: " + e.getMessage());
		}
	}
	// Shuffles the deck
	public void shuffle()  {
	...
	public void getBets(){
		...
		for (int i =0; i < users; i++) {  	
			...
			do {
				System.out.print("enter bet amount " + players[i].getName()  + (" (1-" + players[i].getBank()) + ")? " );
				betValue = ki.nextInt();
