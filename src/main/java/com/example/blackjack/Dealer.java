...
/*
Orchestrates the flow of the Blackjack game.
Encapsulation is followed by encapsulating game-specific logic and tasks.
Adheres to the Single Responsibility Principle by focusing on methods for game initialization, dealing, checking, and more.
Promotes efficiency and clear structure with a main method as the entry point.
 */
public class Dealer {
